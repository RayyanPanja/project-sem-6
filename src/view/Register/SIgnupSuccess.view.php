            ...
            <div class="register-form-container">
                <div class="form-segment">
                    ...
                    <p class="form-text font-size-big">
                        ...
                        With Account Number <span class="badge success-badge"><?= Session::getSession('tempAccount') ?></span>
                    </p>
                    <p class="form-text font-size-big">
                        Please Deposit a Minimum of <span class="badge warn-badge"><?= MIN_ACCOUNT_BALANCE ?></span> in Your Account With in 30 Days , To Keep Your Account Active.
