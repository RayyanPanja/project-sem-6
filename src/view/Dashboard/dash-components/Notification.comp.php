<div class="banner">
    ...
    <form action="<?= $URL->getController("DeleteAllNotifications", "notify") ?>" method="post">
...
<div class="notification-wrapper none" id="notfication-set">
    ...
    ?>
            <div class="notification">
                <div class="notification-read-able">
                    <div class="msg"><?= $UsersNotify[$i]['Notification'] ?></div>
                    <form action="<?= $URL->getController("DeleteNotification", "notify") ?>" method="post">
